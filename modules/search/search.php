<?php
// include_once("modules/xss/xss-clean.php");
// include_once("modules/xss/xss-filter.php");
...
if(isset($_POST['keyword'])){
    ...
    // $keyword = xss_clean($_POST['keyword']);
    // $keyword = $filter->xss($_POST['keyword']);
    
}
else if(isset($_GET['keyword'])){
    $keyword = $_GET['keyword'];
    // $keyword = xss_clean($_GET['keyword']);
    // $keyword = $filter->xss($_GET['keyword']);
}
else{
...
// localhost/k207/vietpro_shop_t/index.php?page_layout=search&keyword=<script>alert("Trang web của bạn đã bị hack")</script>
